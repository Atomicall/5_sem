...
public:
    ...
    void setupUi(QDialog *Authentication_dialog)
    {
        ...
        QObject::connect(DialogButtonBox, SIGNAL(accepted()), Authentication_dialog, SLOT(accept()));
        QObject::connect(DialogButtonBox, SIGNAL(rejected()), Authentication_dialog, SLOT(reject()));
    ...
    {
        Authentication_dialog->setWindowTitle(QApplication::translate("Authentication_dialog", "Dialog", nullptr));
        groupBox->setTitle(QString());
        login_Label->setText(QApplication::translate("Authentication_dialog", "Login", nullptr));
        pass_Label->setText(QApplication::translate("Authentication_dialog", "Password", nullptr));
        remember_CB->setText(QApplication::translate("Authentication_dialog", "rememberMe", nullptr));
    } // retranslateUi
