...
int main()
{
	...
	DWORD  cbWritten1;		// Количество байт, переданных через канал
	DWORD  cbRead1 = 0;			// Количество байт, принятых через канал
	char   szBuf1[BUFSIZ];		// Буфер для передачи данных
	char   szPipeName1[BUFSIZ];	// Буфер для имени канала Pipe
	...
	string DA = "";
	string SA = "2";
	string MESSAGE = "STATion 2 SendS message TO ";
	string FS = "";
	...
	while (TRUE)
	{
		...
		cout << endl << "Read from channel: " << szBuf1 << endl;
